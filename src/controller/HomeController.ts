...
export const homeData = async (
    ...
    expenses.forEach((item) => {
        ...
        console.log("Total Expense", homeData.totalExpenses)
    })

    homeData.sumTotalBalance()

    homeData.saldoDisponivel = homeData.totalAvailableBalance - homeData.totalExpenses
    homeData.saldo = homeData.totalBalance - homeData.totalExpenses
